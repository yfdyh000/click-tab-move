...
const SPAN_KEYS = [KEY_MENU_ITEM, KEY_SELECT_SIZE, KEY_SELECT_SAVE, KEY_NOTIFICATION, KEY_WIDTH, KEY_HEIGHT, KEY_SAVE]
...
(async function () {
  ...
  SPAN_KEYS.forEach((key) => {
    document.getElementById('span_' + key).innerText = i18n.getMessage(key)
  })
